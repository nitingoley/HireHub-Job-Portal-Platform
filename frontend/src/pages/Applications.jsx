            ...
            <tbody>
              {jobsApplied.map((job, index) => (
                <tr key={index}>
                  ...
                  <td className='py-2 px-3 border-b border-gray-300'>{job.title}</td>
                  <td className='py-2 px-3 border-b border-gray-300  max-sm:hidden'>{job.location}</td>
                  <td className='py-2 px-3 border-b border-gray-300 max-sm:hidden'>{moment(job.date).format('ll')}</td>
                  <td className='py-2 px-3 border-gray-300 border-b '>
                    <span
                      className={`${
                        job.status === 'Accepted'
